...
{-
ADOTAMOS COMO PONTO DE PARTIDA QUE O CONJUNTO DOS NÚMEROS INTEIROS ESTÁ PLENAMENTE ESTABELECIDO BEM COMO AS OPERAÇÕES DE SOMA, MULTIPLICAÇÃO E SUBTRAÇÃO.
UM NÚMERO RACIONAL É DEFINIDO COMO UM PAR ORDENADO (a, b) DEFINIDO POR UMA RELAÇÃO DE EQUIVALÊNCIA: (a, b) E (c, d) SÃO EQUIVALENTES SE E SOMENTE SE (a*d)=(b*c).

A MULTIPLICAÇÃO E DIVISÃO SÃO DEFINIDAS POR (a, b)*(c, d)=(ac, bd) E (a, b)/(c, d)=(ad, bc).
O INVERSO MULTIPLICATIVO DE (a, b) É DENOTADO POR (b, a).
A SOMA E SUBTRAÇÃO SÃO DADOS POR (a, b)+(c, d)=(ad+bc, bd), (a, b)-(c, d)=(ad-bc, bd), COM a, b, c, d INTEIROS.
